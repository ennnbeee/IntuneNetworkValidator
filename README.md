...
- Once the script finishes it will export any endpoints that need further investigation to CSV files.
- Use **testScope** to specify the scope of the test.
  - Selections from: `Autopilot`, `Apple`, `Android`, `Windows`, `W365`, `W365-Client`, `W365-CloudPC`, `IntuneSuite`, and `All` (default)
...
- **v0.2.3**
  - Updated with new Remote Help and Intune Suite endpoints
- v0.2.2
